...
public class Kliens{
	...
	public static void main(String[] args) throws Exception
	{
		...
		while(true){
			...
			else if(serverMsg.equals("WRONG"))
			{
				System.out.println("Hibás lépés! Adj meg újat:");	
			}
			else if(serverMsg.equals("TALALT"))
			{
				System.out.println("Eltaláltad a hajót!");	
			}
			else if(serverMsg.equals("NEMTALALT"))
			{
				System.out.println("Nem találtad el a hajót!");	
			}
			else if(serverMsg.equals("HAJO"))
			{
				System.out.println("Hajók lerakása:");	
			}
			else if(serverMsg.equals("TIPP"))
			{
				System.out.println("A tippelési fázis következik,találd el az ellenfél hajóit!");	
			}
			else if(serverMsg.equals("KESZ"))
			{
				System.out.println("Leraktad a hajóidat.");	
			}
